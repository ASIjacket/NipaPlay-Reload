...
class MediaServerTransport {
  ...
  MediaServerTransport({
    ...
    bool? supportsCustomUserAgentHeader,
  })  : _client = platform.createMediaServerClient(),
        _userAgent = _resolveUserAgent(userAgent),
        _supportsCustomUserAgentHeader = supportsCustomUserAgentHeader ??
            platform.supportsCustomUserAgentHeader;
  ...
  final bool _supportsCustomUserAgentHeader;
  ...
  Future<http.Response> send(
    ...
    if (_supportsCustomUserAgentHeader && !hasUserAgent) {
