...
/// Validates an Emby/Jellyfin image candidate with the configured connection
/// User-Agent before the image widget attempts its GET request.
Future<bool> validateMediaServerImageCandidate(
  Uri originalUri, {
