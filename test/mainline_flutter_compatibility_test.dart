...
void main() {
  ...
  test('Flutter setup runs the Erika Windows compatibility patch after pub get',
      () {
    final action = File('.github/actions/setup-flutter/action.yml')
        .readAsStringSync();

    final pubGetIndex = action.indexOf('- name: Flutter Pub Get');
